...
import 'package:new_curso_navegacao_app/main.dart' as app;

void main(){
  IntegrationTestWidgetsFlutterBinding.ensureInitialized();

  group('Modo Foco', (){
    testWidgets('Fluxo completo: Navegando da Home para o Timer em modo Foco (Iniciar / Pausar / Continuar)', (tester) async {
      app.main();
  ...
  group('Pausa Curta', (){
    testWidgets('Fluxo completo: Navegando da Home para o Timer em modo Pausa Curta (Iniciar / Pausar / Continuar)', (tester) async {
      app.main();
      await tester.pumpAndSettle();
  ...
  group('Pausa Longa', (){
    testWidgets('Fluxo completo: Navegando da Home para o Timer em modo Pausa Longa (Iniciar / Pausar / Continuar)', (tester) async {
      app.main();
      await tester.pumpAndSettle();
